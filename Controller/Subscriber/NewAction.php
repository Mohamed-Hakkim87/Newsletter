...
namespace Hikmadh\Newsletter\Controller\Subscriber;
    ...
    public function execute()
    {
        if ($this->getRequest()->isPost() && $this->getRequest()->getPost('email')) {
            ...
            try {
                ...
                return $this->getResponse()->representJson($message);
            } catch (LocalizedException $e) {
                return $this->getResponse()->representJson($e->getMessage());
            } catch (\Exception $e) {
                return $this->getResponse()->representJson(__('Something went wrong with the subscription.'));
            }
        }
    
        return $this->getResponse()->representJson(__('Invalid request.'));
    }
